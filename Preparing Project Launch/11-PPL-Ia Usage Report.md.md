...
| :--- | :--- | :--- |
| 1.0 | 15/04/2026 | Versión base del documento de referencia para la preparación del proyecto final. |
| 1.1 | 29/04/2026 | Ampliación detallada tomando como referencia el documento adjunto de S3/PPL, incorporando evidencias del repositorio, modelos usados, prompts de ejemplo, resultados y reflexiones. |
