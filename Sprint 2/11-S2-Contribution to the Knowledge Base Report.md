...
| 1.2 | 25/03/2026 | Añadir última acción de consolidación |
...
### Contenido aportado
Nuestro contenido aportado durante este Sprint se puede dividir en 2 grupos: el contenido referente a las categorías de feedback que debemos tener en cuenta, y el contenido del feedback relativo unicamente a nuestro grupo. 

Con respecto al feedback general de las categorías, se ha decidido que el Grupo 11 Current sea el encargado de gestionar las siguientes secciones: Team Organization (referente a como presentar la organización del equipo),
...
En cuanto al feedback respectivo al Grupo 11, se puede ver de misma manera en la carpeta del grupo 11, el archivo llamado "S2". Ese archivo a su vez se puede diferenciar en 2 secciones: una para el día 05 de Marzo, y otra para el 12 de Marzo. En ambos días se señalan nuestras fortalezas y debilidades
...
mpradoj04 (dichos cambios han sido realizados los días 12, 20 y 25 de Marzo), usuario correspondiente a uno de los miembros del grupo 11. 
...
Por supuesto encontrarán que todas las acciones han sido realizadas en los documentos mentados al inicio.
